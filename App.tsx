...
export default function App() {
  ...
  //
  // Fix #8: maxTokens increased to 16000 for 70b models to handle 100-question papers.
  //         llama-3.1-8b kept lower to stay within its context window.
  const GROQ_MODELS = [
    { model: 'llama-3.3-70b-versatile',                   maxTokens: 16000 },
    { model: 'meta-llama/llama-4-scout-17b-16e-instruct', maxTokens: 16000 },
