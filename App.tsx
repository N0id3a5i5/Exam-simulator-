...
export default function App() {
  ...
  const startExtraction = async () => {
    ...
    try {
      ...
      addLog('Engine: gemini-2.0-flash — ready');
      ...
      const parsed = JSON.parse(rawText) as Question[];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: 16 }}>
      {loading ? (
        ...
        <div className="upload-card">
          ...
          <p style={{ fontSize: 13, color: 'var(--muted)', textAlign: 'center', marginBottom: 28 }}>Upload a question paper PDF to begin your timed test</p>
